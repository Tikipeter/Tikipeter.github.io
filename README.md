...
VIDEO THUMBS: `thumbnail = https://th.easynews.com/thumbnails-%s/pr-%s.jpg % (post_hash[0:3], post_hash[:-4])`

IMAGE THUMBS: `thumbnail = https://th.easynews.com/thumbnails-%s/sm-%s.jpg % (post_hash[0:3], post_hash[:-4])`
